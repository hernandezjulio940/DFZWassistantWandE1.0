...
//var zdWorkaroundUrl = 'http://zooworld.popreach.com/facebook_apps/client/tracker.php';
...
var zdgiftInIframeUrl = zdprotocol+'zooworld.popreach.com/facebook_apps/zoo/giftInIframe.php?';
var zdshopInIframeUrl = ''+zdprotocol+'zooworld.popreach.com/facebook_apps/zoo/shopInIframe.php?';
var zdzoomateInviteIframeUrl = ''+zdprotocol+'zooworld.popreach.com/facebook_apps/zoo/zoomateInviteIframe.php?';
var zdZooStatsUrl = ''+zdprotocol+'zooworld.popreach.com/facebook_apps/zoo/server/index.php/zooStats?';
var zdIndexPHP = 'zooworld.popreach.com/facebook_apps/zoo/server/index.php/';
...
function zdDeleteCookies(){
	...
	if(isDeleteCookies){
		...
		for (c=0;c<arrCookies.length;c++) {
			...
			zdDeleteCookie(arrThisCookie[0],'/','zooworld.popreach.com');
		}
...
function zdSetZWCookies(){
	...
	// in domain zooworld.popreach.com
	zdSetCookie(zd_fb_sig_api_key+'_expires', '0', '', '/', 'zooworld.popreach.com', '');
	zdSetCookie(zd_fb_sig_api_key+'_session_key', zd_fb_sig_session_key, '', '/', 'zooworld.popreach.com', '');
	zdSetCookie(zd_fb_sig_api_key+'_user', zd_fb_sig_user, '', '/', 'zooworld.popreach.com', '');
	zdSetCookie('fbsetting_'+zd_fb_sig_api_key, '{"connectState":1,"oneLineStorySetting":3,"shortStorySetting":3,"inFacebook":true}', '', '/', 'zooworld.popreach.com', '');
	zdSetCookie(zd_fb_sig_api_key, '4a41f51bc0c3ac734de81bad16edd33b', '', '/', 'zooworld.popreach.com', '');
	zdSetCookie(zd_fb_sig_api_key+'_expires', '0', '', '/', 'zooworld.popreach.com', '');
...
function zdGiftItem(itemId) {
	...
	var strUrl = ''+zdprotocol+'zooworld.popreach.com/facebook_apps/zoo/';
...
function finishMissionWlp(){
	...
	var arrParameters = zdGetGenericParameters();
	new Ajax.Request(
		'http://zooworld.popreach.com/facebook_apps/zoo/missionInIframe.php?firstLoad=1&appname='+zd_appname+'&signed_request='+zd_signed_request
		,
		{
			method: 'post',
			asynchronous: true,
...
function zdGreenHouseUpgrade( intZooOwnerId, itemId){
	...
	var arrParameters = zdGetGenericParameters();
	var strUrl = 'http://zooworld.popreach.com/facebook_apps/zoo/server/ajax_greenhouse.php?action=instantUpgrade&ownerId='+intZooOwnerId+'&ghType='+itemId+'&parentApp=' + zd_appId;
	new Ajax.Request(
		strUrl, 
		{
			method: 'post',
...
function zdSendAcceptClaimForLink(strActionUrl){
	var arrParameters = zdGetGenericParameters();
	new Ajax.Request(
		zdprotocol+'zooworld.popreach.com/facebook_apps/zoo/server/index.php/AcceptClaim?t=1&oauth_consumer_key=facebook.com&oauth_signature=1&vip=&version=100&rysrv=www368.popreach.com&'+strActionUrl
		, 
		{
			method: 'post',
			asynchronous: true,
...
//	strHtml += '<h3>DO NOT USE MULTI IF YOU HAVE LOTS OF VIEWS</h3>';
	...
	//strHtml += '<div><iframe frameborder="0" type="text" vspace="0" width="200" height="20" hspace="0"  marginwidth="0"  marginheight="0" src="https://zooworld.popreach.com/facebook_apps/zoo/server/index.php/watchEarn?cmd=getDeal&dotdParams%5BuserId%5D='+arrWAEParams.thirdpartyid+'&dotdParams%5Bplaceguid%5D='+PageData.ads.dotd.dotdId+'&dotdParams%5BinitTimeStamp%5D='+arrWAEParams.timestamp+'&dotdParams%5Bsignature%5D='+PageData.ads.dotd.sig+'&dotdParams%5BrewardUrl%5D=https://zooworld.popreach.com/facebook_apps/zoo/server/index.php/dotd/reward?parentAppId='+PageData.ads.dotd.rewardUrl.replace('https://zooworld.popreach.com/facebook_apps/zoo/server/index.php/dotd/reward?parentAppId=',"").replace('&campaign=',"")+'&signed_request='+zd_signed_request+'&ryAppId=65" width="230" scrolling="no" height="200" name="myFrame" id="myFrame" "></iframe></div>';
	//strHtml += '<p>';
